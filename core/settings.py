...
# Another API key
ANOTHER_API_KEY = os.environ.get('ANOTHER_API_KEY', 'AQ.Ab8RN6J-R-cDhJqWCWzqWPaPDh0XaCi4DtMfpW6Qw3NkqHYY8Q')
...
# Support email
SUPPORT_EMAIL = os.environ.get('SUPPORT_EMAIL', 'support@nyumbafinder.co.ke')


# Payment amounts
AMOUNT_TO_PAY_PER_HOUSE = int(os.environ.get('AMOUNT_TO_PAY_PER_HOUSE', 100))
AMOUNT_TO_PAY_YEAR = int(os.environ.get('AMOUNT_TO_PAY_YEAR', 800))
...
MPESA_OAUTH_URL = os.environ.get("MPESA_OAUTH_URL", '')
